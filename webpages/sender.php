...
$sender_code = $info->data->recipient_code; 
$type = $info->data->type; 
...
$stmt = $con->prepare("INSERT INTO transfer_sender( account_name, sender_code, ntype, account_number, bank_code, 
bank_name, currency, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"); 
$stmt->bind_param("ssssssss", $sender_name, $sender_code, $type, $Acct_Numb, $Bank_Code, $Bank_Name, $currency,
$createdAt);
$stmt->execute();
if(!$stmt){
