...
<form action="database/signupa.inc.php" method="post">
<div class="input">
     <label class="labelstyle" for="adminid"> Admin id  </label></br>
     <input type="text" class="form-control" name="adminid" style="float: left;width: 70%;height:50px;background: #ffffff;border-radius: 10px; font-size:20px;"
...
<div class="buttonpos1"><input type="submit" class="btn btn-primary mb-3" name="createAccountA"style="width:100px ; height:50px ;background: #ECDFDF ; color:#05224B;
    border-radius: 99px;font-size: 20px; padding-top: 10px; margin-right:10% ; " 
    name="account" value="Confirm"></button></div> 

    

<div class="buttonpos2"> <a href="Aloginpage.php" class="btn btn-primary mb-3" style="width:100px ; height:50px ;background: #B9DAFA; color:#05224B;
